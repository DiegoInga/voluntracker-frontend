...
var fe = yt({
  ...
  setup(s, { emit: a }) {
    const t = s, n = a, r = f(false), g = f(false), T = f(false), P = f(false), h = f(false), u = f(0), m = f(0), y = f(
      t.toast.duration || t.duration || Wt
    ), H = f(null), B = f(null), pt = v(() => t.index === 0), ht = v(() => t.index + 1 <= t.visibleToasts), I = v(() => t.toast.type), Y = v(() => t.toast.dismissible !== false), gt = v(() => t.toast.class || ""), o = v(() => t.descriptionClass || ""), i = t.toast.style || {}, l = v(
        ...
        e.toast.component ? (d(), X(et(e.toast.component), ft({ key: 1 }, e.toast.componentProps, { onCloseToast: bt }), null, 16)) : (d(), p(F, { key: 2 }, [
          I.value !== "default" || e.toast.icon || e.toast.promise ? (d(), p("div", {
            ...
            e.toast.icon ? (d(), X(et(e.toast.icon), { key: 0 })) : (d(), p(F, { key: 1 }, [
              I.value === "loading" ? D(e.$slots, "loading-icon", { key: 0 }) : I.value === "success" ? D(e.$slots, "success-icon", { key: 1 }) : I.value === "error" ? D(e.$slots, "error-icon", { key: 2 }) : I.value === "warning" ? D(e.$slots, "warning-icon", { key: 3 }) : I.value === "info" ? D(e.$slots, "info-icon", { key: 4 }) : W("", true)
            ], 64))
          ], 2)) : W("", true),
          L("div", {
            "data-content": "",
          ...
          }, dt(N(ut)(e.toast.cancel) ? (Lt = e.toast.cancel) == null ? void 0 : Lt.label : e.toast.cancel), 7)) : W("", true),
          ...
          }, dt(N(ut)(e.toast.action) ? (Rt = e.toast.action) == null ? void 0 : Rt.label : e.toast.action), 7)) : W("", true)
        ], 64))
      ], 46, le);
    };
  }
...
var be = yt({
  ...
  setup(s) {
    ...
    return (t, n) => (d(), p("div", {
      ...
      L("div", ye, [
        (d(true), p(F, null, mt(N(a), (r) => (d(), p("div", {
          key: `spinner-bar-${r}`,
...
var Ve = yt({
  ...
  setup(s) {
    ...
    return R((o) => {
      ...
      (d(true), p(F, null, mt(T.value, (l, k) => {
        var b;
        return d(), p("ol", ft({
          key: l,
          ref_for: true,
          ...
          (d(true), p(F, null, mt(g.value(l, k), (z, O) => {
