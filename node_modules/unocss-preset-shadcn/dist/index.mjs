...
function generateCSSVars(theme, onlyOne = true) {
...
const builtinRadiuses = [0, 0.3, 0.5, 0.75, 1];
function presetShadcn(themeOptions = {}, controlOptions = {}) {
...
export { builtinColors, builtinRadiuses, presetShadcn as default, presetShadcn };
